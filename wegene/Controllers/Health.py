...
"""
   wegene.Controllers.HealthController
...
class Health(object):
    ...
    def get_carrier(self,
                       profile_id,
                       report_id):
        """Does a POST request to /health/carrier/{profile_id}.

        Disease carrier information based on genetic information

        Args:
            profile_id (string): Genetic profile Id
            report_id (string): Report Id for the specific disease carrier to
                look
        ...
        query_builder += "/health/carrier/{profile_id}"
